...
(cl:defmethod cl:initialize-instance :after ((m <FloatStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FloatStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ivr_assignment-msg:<FloatStamped> is deprecated: use ivr_assignment-msg:FloatStamped instead.")))
...
(cl:defmethod angle-val ((m <FloatStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ivr_assignment-msg:angle-val is deprecated.  Use ivr_assignment-msg:angle instead.")
  (angle m))
